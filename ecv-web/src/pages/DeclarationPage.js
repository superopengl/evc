...
const DeclarationPage = () => (
  <ContainerStyled>
    ...
    <Title style={{ textAlign: 'center' }}>Easy Value Check Pty Ltd Declaration</Title>
    <p>I declare that the information provided for the preparation of the task is true and correct.</p>
    <p>For the document where it is to be lodged to the ATO electronically. I, the business owner, authorise J.Z. Accounting trading as Easy Value Check to give the e-signed document to the commissioner of Taxation. The agent is authorised to lodge this form.</p>
