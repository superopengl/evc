...
export class CreateAdminUser1596415746494 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO evc."user_profile" (id, "email", "givenName", "surname", country)
        VALUES (
    ...
    await queryRunner.query(`INSERT INTO evc."user" ("emailHash", secret, salt, role, "profileId")
        VALUES (
