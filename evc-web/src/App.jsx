...
const App = () => {
  ...
  const initalize = async () => {
    ...
    // React 18+ batches these automatically. ReactDOM.unstable_batchedUpdates is not on
    // react-dom's ESM default export, so under Vite it was undefined and threw here - which
    // left `loading` true and the app stuck on its spinner.
    setUser(user);
    setLoading(false);
    setReady(true);
  }
