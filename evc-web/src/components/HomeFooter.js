    ...
    <section id="about" style={{ maxWidth: 800 }}>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <div></div>
          <p>
            All data provided on Easy Value Check is provided to individuals for informational purposes only, and is not
            intended for trading or investing purposes. You must not redistribute information displayed on or provided
            by Easy Value Check.
          </p>
