...
const ChineseUserPaymentGuidePage = () => (
  <ContainerStyled>
    ...
    <Alert description="信用卡和带有“银联”标志的储蓄卡，均可付款，流程如下" showIcon  style={{marginBottom: 30}}/>
    <Title level={3}>如果您持有“银联”标志的信用卡或储蓄卡，请点击“PayPal”</Title>
    ...
    <Title level={3}>如果您持有Visa、MasterCard信用卡，请点击“信用卡支付”（Pay By Card）</Title>
