...
const ChineseUserPaymentGuidePage = () => (
  <ContainerStyled>
    ...
    <Title style={{ textAlign: 'center' }}>中国用户支付指南</Title>
    <p>信用卡和带有“银联”标志的储蓄卡，均可付款，流程如下：</p>
    <ol>
      <li>
        <p>如果您持有“银联”标志的信用卡或储蓄卡，请点击“PayPal”。<br/><Image width={400} src="/images/cn_guide/3.png" /></p>
      ...
      <li>
        <p>如果您持有Visa、MasterCard信用卡，请点击“信用卡支付”（Pay By Card）。<br/><Image width={400} src="/images/cn_guide/1.png" /></p>
