  ...
  return (
    <LayoutStyled>
      ...
      <ContainerStyled>
        ...
        <Paragraph>Client register as user in our platform to authorise Easy Value Check to be the accountant and tax agent to deal with all the task set up in each portfolio which is under the user’s name. The task can be set up either by client itself or Easy Value Check according to engagement letter.</Paragraph>
