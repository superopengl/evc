...
const ReferreeDiscountGlobalPolicyListPage = () => {
...
ReferreeDiscountGlobalPolicyListPage.propTypes = {};

ReferreeDiscountGlobalPolicyListPage.defaultProps = {};

export default withRouter(ReferreeDiscountGlobalPolicyListPage);
